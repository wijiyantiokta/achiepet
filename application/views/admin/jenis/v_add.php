<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Tambah Data Layanan Grooming</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">Tambah Data Layanan Grooming</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="card-body">
              ...
              <form action="<?= base_url() ?>admin/jenis/add" method="post">
                <div class="form-group">
                  ...
                  <input type="text" name="jenis_grooming" class="form-control" placeholder="Jenis Grooming" required="">
                </div>
                <div class="form-group">
