...
$totadmin = $this->public_model->totadmin();
$totpelanggan = $this->public_model->totpelanggan();
$totlayanan = $this->public_model->totlayanan();
$totbooking = $this->public_model->totbooking();
?>
      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Pelanggan Bergabung</span>
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?= $totadmin ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
